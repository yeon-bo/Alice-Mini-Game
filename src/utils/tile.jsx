...
export function getRowAndCol(index) {
...
export function checkTileChanged({
  prevRow,
  row,
  prevCol,
  col,
...
export function isChanged(arr) {
  let changed = arr.some(checkTileChanged);
  return changed;
}

export function getEmptyPosition(arr, isInit) {
  return arr.reduce(
...
export function checkAllValueIsTrue(array) {
  return !array.some((tile) => !tile);
}

export function getNewTile(arr, isInit = null) {
...
export function checkIsCombinable(numbers) {
